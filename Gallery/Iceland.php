...
<!-- Maximum characters = 250 -->
				...
				<p id="TextHallgrimskirkja" class="MainText ExtraHeadRoom Readability">There's no question that the Hallgrímskirkja is the most impressive sight in Reykjavík. It's white, and bright, very simple and clean lines. It's gorgeous in a stark kind of way.</p>
		...
		<div id="Thumbnails">
			...
			<div class="GalleryThumbs" id="Thumb9" onClick="ChangeImage('Hallgrimskirkja')"></div>
